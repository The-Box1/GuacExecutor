...
namespace Guac.Updating
{
    internal class GuacUpdateXml
    {
        ...
        internal GuacUpdateXml(Version version, Uri uri, string fileName, string md5, string description, string launchArgs)
        {
        ...
        {
            string versionString = this.version > version ? "Newer" : "Up to date";
        ...
        internal static GuacUpdateXml Parse(Uri location, string appID)
        {
            ...
            try
            {
                ...
                return new GuacUpdateXml(version, new Uri(url), fileName, md5, description, launchArgs);
            }
            catch
            {
                return null;
